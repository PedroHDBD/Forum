...
public class DBQuery {
	...
	public int executeAndGetGeneratedKeys(String sql) {
	    try (PreparedStatement preparedStatement = new DBConnection().getConnection().prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
