	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ("adicionarTopico".equals(acao)) {
			...
			if (caminhoImagem != null && !caminhoImagem.isEmpty()) {
				dbquery = new DBQuery("Publicacao", "idTopico, texto, idUsuario, imagem, username", "idPublicacao");
				String[] publicacao = { String.valueOf(idNovoTopico), texto, String.valueOf(idUsuario),caminhoImagem, username};
