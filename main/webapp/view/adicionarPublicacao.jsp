...
<body>
	...
	<div class="row justify-content-center m-0 p-1">
		...
		<div class="col-12 col-md-10 col-lg-8 col-xl-6">
			...
			<form id="adicionarPublicacao" enctype="multipart/form-data"
				class='bg-dark-subtle py-2 px-3 rounded-3 shadow'>
				...
				<br> <input type="submit" name="submit" value="Publicar"
	...
	<script
		src="${pageContext.request.contextPath}/scripts/adicionarPublicacao.js"></script>
</body>
</html>